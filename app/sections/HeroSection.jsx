  ...
  return (
    <div className="h-[80vh] border-b-2 border-black bg-amber-400 items-center justify-between text-black flex lg:px-32 ">
      <div className="flex flex-col-reverse mt-20 lg:w-[90%] mx-auto lg:flex-row ">
        <div className="  text-center lg:ml-0 lg:w-1/2">
          <h1 className=" ml-8 lg:ml-0 mt-3 lg:mt-0 text-4xl lg:text-6xl font-[ssp] font-bold">Keep Reading</h1>
        ...
        <div className=" flex hidden md:block lg:justify-end">
          <Carousel />
        </div>
      </div>
    </div>
